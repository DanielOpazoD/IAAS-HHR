...
export default function DashboardPage() {
  ...
  // One-shot parallel reads — no persistent onSnapshot listeners.
  // This eliminates Firestore assertion errors on the Dashboard.
  const { cirugias, partos, dip, arepi, iaas, loading } = useDashboardStats(anio)
