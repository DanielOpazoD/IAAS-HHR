  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-primary-950 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-primary-600/5 rounded-full blur-2xl" />
        {/* Grid pattern */}
      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-10 text-center">
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-primary-50 rounded-full mb-8">
            ...
            <span className="text-xs font-medium text-primary-700">Sistema de Vigilancia Epidemiologica IAAS</span>
          </div>

          <button
            onClick={signIn}
            className="w-full flex items-center justify-center gap-3 px-4 py-3.5 bg-gray-900 rounded-xl text-sm font-semibold text-white hover:bg-gray-800 transition-all shadow-lg hover:shadow-xl active:scale-[0.98]"
          >
