...
const navItems = [
  ...
  { to: '/cirugias', label: 'Cirugias Trazadoras', icon: 'M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2' },
  { to: '/partos', label: 'Partos / Cesarea', icon: 'M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z' },
  ...
  { to: '/consolidacion', label: 'Consolidacion Tasas', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
]
  ...
  return (
    <aside data-testid="sidebar" className={`${collapsed ? 'w-[72px]' : 'w-64'} bg-gradient-to-b from-primary-900 to-primary-950 text-white min-h-screen flex flex-col flex-shrink-0 transition-[width] duration-200`}>
      ...
      <div className="pb-2 space-y-0.5">
        ...
        {role === 'admin' && adminItems.map((item) => <NavItem key={item.to} item={item} collapsed={collapsed} />)}
      </div>
